...
class UserBookingCard extends StatelessWidget {
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                if (b.tripStatus != null && b.tripStatus != 'scheduled' && isConfirmed) ...[
                   const SizedBox(height: 12),
                   _buildTripDisruptionAlert(context),
                ],
  ...
  Widget _buildTripDisruptionAlert(BuildContext context) {
    Color iconColor;
    Color bgColor;
    String message;
    IconData icon;

    switch (b.tripStatus?.toLowerCase()) {
      case 'delayed':
        bgColor = Colors.amber.withOpacity(0.1);
        iconColor = Colors.amber.shade900;
        icon = Icons.timer_rounded;
        message = 'تأخير في الرحلة: ${b.delayMinutes ?? 0} دقيقة';
        break;
      case 'diverted':
      ...
      case 'emergency':
        ...
        message = 'حالة طارئة - يرجى التواصل مع الدعم';
        break;
      default:
