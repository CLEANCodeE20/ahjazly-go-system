...
import '../../data/models/support_ticket_view_model.dart';
...
class _TicketSubmissionSheetState extends State<TicketSubmissionSheet> {
  ...
  void initState() {
    super.initState();
    // Use Get.put to ensure controller exists, with permanent: false so it gets disposed
    _controller = Get.put(SupportTicketController(), permanent: false);
  }
