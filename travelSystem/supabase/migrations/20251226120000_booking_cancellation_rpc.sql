-- Function to preview or perform booking cancellation
...
BEGIN
    ...
    IF v_policy_id IS NULL THEN
        -- Fallback to partner's default policy
    ...
    -- If no rule found, assume 0 refund or default
    IF NOT FOUND THEN
        v_refund_amount := 0;
    ...
    -- 5. If p_confirm is true, actually perform the cancellation
    IF p_confirm THEN
        -- Update booking
