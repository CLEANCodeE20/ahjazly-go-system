-- ========================================================
-- NOTIFICATION FIX: SINGLE HEADER + POSITIONAL ARGS
-- ========================================================
...
BEGIN
  -- We use ONLY the Authorization header now. 
  -- Some proxies get confused if both Authorization and apikey are present.
